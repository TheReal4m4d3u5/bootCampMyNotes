...
// Defines an interface `IBook` that extends the `Document` type (typically from Mongoose) and represents the structure of a book document in the database. 
// This interface helps enforce type-checking for book documents, ensuring that any objects of type IBook have at least title and lastAccessed, with other properties being optional.
