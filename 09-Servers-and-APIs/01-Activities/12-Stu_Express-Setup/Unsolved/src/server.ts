...
app.get('/', (_req: Request, res: Response) => res.send('Navigate to /send or /paths')); //not needed
...
app.get('/paths', (_req: Request, res: Response) => //_req the _ says we are not going to use it
