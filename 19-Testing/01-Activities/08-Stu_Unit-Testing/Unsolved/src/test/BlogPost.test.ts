...
describe('BlogPost', () => {
  ...
  // This test ensures that the addComment() method of the 
  // BlogPost class correctly adds a Comment instance to the comments array property of the blog post. Here's a descriptive comment:
