...
import { OpenAI } from '@langchain/openai'; //contructs queries to open ai
import { PromptTemplate } from '@langchain/core/prompts'; //2 and 3 work together to generate query 
