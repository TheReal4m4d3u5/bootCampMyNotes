let one = 64.55; // number 
let two = 'Howdy!'; //string 
const three = '656302'; //string
const four = 64;  // int number
const five = false; // boolean 
const six = null;  // infered as any and output as object
let seven;        // ? inferred type is any but typescript is undefined
